      ...
      <div class="row">
        <div class="col-md-6 col-lg-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" method="POST" action="simpanmasuk.php">
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="datetimepicker">Waktu Selesai</label>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" required="required" name="tempat">
                </div>                
              </div>
              <!-- /.box-body -->
