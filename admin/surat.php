                                    ...
                                    while ($h = $hasil->fetch_array()){
                                        ...
                                        <tr>
                                         ...
                                         if ($h['status']=="Selesai") {
                                           ...
                                           echo "<a href='proses.php?id=$h[id_surat]' class='btn btn-danger btn-sm'><i class='fas fa-pencil-alt'>Proses Surat</i></a>";
                                          }  else if ($h['status']=="Ditolak") {
                                           echo "<a href='proses.php?id=$h[id_surat]' class='btn btn-danger btn-sm'><i class='fas fa-pencil-alt'>Proses Ulang</i></a>";
                                           ...
                                           echo "<a href='#' class='btn btn-warning btn-sm'><i class='fas fa-pencil-alt'>Menunggu Disposisi</i></a>";
                                            ...
                                            echo "<button type='button' class='btn btn-primary' data-toggle='modal' data-target='#exampleModal' data-whatever='@mdo'><i>Kirim Surat</i></button>";
                                          }
