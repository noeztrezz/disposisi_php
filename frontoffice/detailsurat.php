           ...
           ?>
            <div class="box-body box-profile">
              <ul class="list-group list-group-unbordered">
                ...
                <li class="list-group-item">
                  <b>Detail pengiriman surat</b> <a href="riwayatsurat.php?id=<?php echo $sin['id_surat'] ?>" class="pull-right">Klik Disini</a>
                </li>
                <li class="list-group-item">
                  <b>Bidang Penginput</b> <a class="pull-right"><?php 
                  $sqlb = $con->query("SELECT * FROM sub_bidang WHERE id_sub=".$sin['id_input']);
