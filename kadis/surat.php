            ...
            <div class="box-body">
              <table class="table table-striped tabl-bordered nowrap" style="width:100%" id="myTable">
                            ...
                            <tbody>
                                <?php
                                include "../koneksi.php";
                                $sql = "SELECT * FROM surat where id_penerima=".$_SESSION['idpenerima'];
                                $hasil = $con->query($sql);
                                ...
                                if ($hasil == FALSE){
                                    ...
                                    while ($h = $hasil->fetch_array()){
                                        ...
                                        <tr>
                                         ...
                                         <td><p><?php
                                         if ($h['status']=="Menunggu Disposisi") {
                                           echo "<button type='button' class='btn btn-danger' data-toggle='modal' data-target='#exampleModal' data-whatever=".$h['id_surat']."><i>Disposisi</i></button> </button> <button type='button' class='btn btn-warning' data-toggle='modal' data-target='#tesModal' data-kepo=".$h['id_surat']."><i>Tolak</i></button>";
                                         ...
                                         }elseif ($h['status']=="Validasi Akhir") {
                                           echo "<button type='button' class='btn btn-danger' data-toggle='modal' data-target='#kirimModal' data-kirim=".$h['id_surat']."><i>Disposisi</i></button> </button> <button type='button' class='btn btn-warning' data-toggle='modal' data-target='#tesModal' data-kepo=".$h['id_surat']."><i>Tolak</i></button>";
                                         }else {
        ...
        <form action="prosesdisposisi.php" method="post">
          <div class="form-group">
            ...
            <select class="form-control" name="id_disposisi">
              ...
              <?php
                include '../koneksi.php';
                $query = "select * from sub_bidang where id_sub>2";
        ...
        <form action="prosesdisposisi2.php" method="post">
          <div class="form-group">
            ...
            <select class="form-control" name="id_disposisi">
              ...
              <?php
                include '../koneksi.php';
                $query = "select * from sub_bidang where nama_sub='subag umum'";
                $hasil = mysqli_query($con,$query);
                while($data=mysqli_fetch_array($hasil)){
                  echo "<option value=$data[id_sub]>$data[nama_sub]</option>";
                }
