        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <center><h3 class="box-title"><a href="tambahsurat.php" class="btn btn-primary btn-sm"><i class="fas fa-pencil-alt">Tambah Surat</i></a></h3></center>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                                        ...
                                        <tr>
                                         ...
                                         if ($h['status']=="Selesai") {
                                           ...
                                           echo "<a href='#' class='btn btn-warning btn-sm'><i class='fas fa-pencil-alt'>Menunggu Disposisi</i></a>";
                                            ...
                                            echo "<button type='button' class='btn btn-warning'><i>Sedang Diproses</i></button>";
                                          }
