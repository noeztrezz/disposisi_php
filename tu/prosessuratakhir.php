      ...
      <div class="row">
        <div class="col-md-6 col-lg-12">
          ...
          <div class="box box-primary">
            <!-- form start -->
            <form role="form" method="POST" action="prosesakhir.php" enctype="multipart/form-data">
              <div class="box-body">
                <input type="hidden" name="id_surat" value="<?php echo $sin['id_surat'] ?>">
                <div class="form-group">
                  <label>Lampiran</label>
                  <input type="file" name="surat_jadi" class="form-control">
                </div>                
                <div class="form-group">
                  <label>Nomor Surat</label>
                  <input type="text" class="form-control" name="no_dinas" required="required">
                </div>
                <div class="form-group">
                  <label>Catatan</label>
